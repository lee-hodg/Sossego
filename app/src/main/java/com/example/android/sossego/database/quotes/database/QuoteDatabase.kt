...
/**
 * A database that stores DatabaseQuotes
 * And a global method to get access to the database.
 *
 * This pattern is pretty much the same for any database,
 * so you can reuse it.
 */
@Database(entities = [DatabaseQuote::class], version = 1,
    exportSchema = false)
abstract class QuoteDatabase : RoomDatabase() {
     ...
     *
     * For example, clients can call `QuoteDatabase.getInstance(context)` to instantiate
     * a new QuoteDatabase.
     */
    companion object {
        /**
